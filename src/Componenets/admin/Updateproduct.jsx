...
import { clearError, clearProductUpdated } from '../../Slice/Singleproduct';
import { getProduct, updateProduct } from '../../action/Singleproductaction';
...
function Updateproduct() {
    ...
    // Ensure product has initial value
    const { loading, isProductUpdated, error, product = {} } = useSelector(state => state.productsingle);
    ...
    // Effect to handle product update success or error
    useEffect(() => {
        if (isProductUpdated) {
    ...
    // Effect to update form fields when product details are fetched
    useEffect(() => {
